...
export const SOURCES: SourceRow[] = [
  ...
  { group: "안양시 공공데이터", provider: "경기도 안양시 (공공데이터포털)", name: "안양시_수방자재 현황", url: "https://www.data.go.kr/data/15085817/fileData.do", asof: "2025-12-30", license: "공공누리(포털 표기)", use: "동별 재난 대비 현황(참고)" },
  { group: "안양시 공공데이터", provider: "경기도 안양시 (공공데이터포털)", name: "안양시_공동주택 현황", url: "https://www.data.go.kr/data/3045074/fileData.do", asof: "2025-09-22", license: "공공누리(포털 표기)", use: "참고(공동주택 단지 현황)" },
  { group: "국가 공간정보", provider: "국토교통부 (브이월드 공간정보 다운로드)", name: "GIS건물통합정보 — 경기도 전체본 2026-09-09·2025-09-04", url: "https://www.vworld.kr/dtmk/dtmk_ntads_s002.do?dsId=30561", asof: "2026-09-09", license: "CC BY", use: "건물 27,713동 도형·속성, 위반 표기(A20), 1년 변화(신규 88·해제 64), AI 점수 학습 데이터", limit: "대장 미연계 4,112동은 용도·구조 없음. 높이 0·이상치는 정보없음 처리" },
