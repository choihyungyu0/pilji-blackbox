...
/**
 * SEC-01 공개/담당자 모드 분리.
 * 담당자 전용: /work, /cases, /print, /investigate, /agent, /api/agent, /api/doc, /api/verdict, /api/candidates, /api/adjust, /data/officer/*
...
export const config = {
  matcher: ["/work/:path*", "/cases/:path*", "/print/:path*", "/investigate/:path*", "/agent/:path*", "/api/agent/:path*", "/api/doc/:path*", "/api/verdict/:path*", "/api/candidates/:path*", "/api/adjust/:path*", "/data/officer/:path*"],
};
