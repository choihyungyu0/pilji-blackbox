...
P0 전부 구현. P1 중 구현: TML-02 이벤트 유형 칩, PCL-03 주변 현황(위반·미연계·급경사지·시설), **PCL-04 필지 여건**(`lib/context.ts` — 어느 필지든 행정동·수방자재·개발제한구역·급경사지·공공건축물·대피/급수시설·공동주택 단지·착공신고·사고·이웃 위반을 반경 대조 + 적용 법령; 필지 패널·사건 상세·에이전트 timeline_build 에 공통), SEC-04 작업 로그(기기 보관 + Supabase 선택), DAT-09 시설 4종 지오코딩(공공건축물 450·대피 213·급수 45·공동주택 176).
